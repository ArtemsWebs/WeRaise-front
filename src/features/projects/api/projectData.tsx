...
function getShortProject() {
  return {
    investors: faker.number.int({ min: 1000, max: 1000000 }),
    image: faker.image.personPortrait({ size: 128 }),
    investment: faker.number.int({ min: 1000000, max: 100000000 }),
    coinvester: faker.company.name(),
  };
}
